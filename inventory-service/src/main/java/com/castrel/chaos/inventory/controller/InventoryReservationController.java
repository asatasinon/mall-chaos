...
public class InventoryReservationController {
    ...
    public ApiResponse<Map<String, Object>> prepare(
        ...
        reservationService.prepare(ScenarioRunContext.fromHeaders(headers));
    ...
    public ApiResponse<Map<String, Object>> remove(
            @RequestHeader org.springframework.http.HttpHeaders headers) {
        return ApiResponse.ok(reservationService.remove(ScenarioRunContext.fromHeaders(headers)));
    }

    @PostMapping("/summary")
    public ApiResponse<Map<String, Object>> summary(
            @RequestHeader org.springframework.http.HttpHeaders headers) {
        return ApiResponse.ok(reservationService.summary(ScenarioRunContext.fromHeaders(headers)));
    }
}