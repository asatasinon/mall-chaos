...
| `HikariPoolExhaustion`、`HikariPoolFull`、`HikariPoolPending`、`MySQLHighThreads`、`MySQLSlowQueries` | 连接池告警达到对应规则阈值；MySQL 连接数超过 255，持续 1 分钟；或慢查询速率超过 0.5 次/秒，持续 1 分钟 | 查询流量扩大并占用数据库资源时可能出现。 |
