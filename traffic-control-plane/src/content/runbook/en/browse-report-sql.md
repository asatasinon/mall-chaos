...
| `MySQLHighThreads`, `NodeHighCPU` | MySQL connections exceed 255 for 1 minute, or node CPU reaches the relevant rule threshold | Appears only when pressure spreads to shared resources. |
