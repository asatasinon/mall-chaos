...
- T4.1：order、payment、risk、fulfillment、notification 的 Outbox publisher 均支持条件式 claim、到期 FAILED 重试、有限退避和 DEAD_LETTER；各服务仍只访问自己的事件表，跨服务事件投递均传递完整 envelope。完整租约恢复和重复投递验证保留在 T4.8。
