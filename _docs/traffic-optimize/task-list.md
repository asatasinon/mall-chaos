...
- [x] 更新根级产品/技术设计、README、环境说明和运维 Runbook，说明真实登录模式、常规/故障边界、补齐机制和新的运行配置。
- [x] 记录全新 Schema 初始化步骤、配置 Secret、Gateway 新路由与发布前置条件。
- [x] 将实施结果回填本任务清单、[product.md](product.md) 和 [technical-design.md](technical-design.md) 的状态/更新时间。
